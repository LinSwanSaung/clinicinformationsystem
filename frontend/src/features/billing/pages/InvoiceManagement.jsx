      ...
      if (!invoice && invoiceId) {
        try {
          ...
          const transformedInvoice = {
            ...
            medications: (data.invoice_items || [])
                                ...
                                >
                                  ...
                                  <div className="text-right">
                                    <p className="font-medium">
                                      ...
                                      {med.action === 'dispense'
                                        ? (
                                            (med.price * med.dispensedQuantity) /
                                            med.quantity
                                          ).toFixed(2)
                                        : '0.00'}
                                    </p>
                            ...
                            >
                              ...
                              {med.action === 'dispense' && (
                                <motion.div
                                  ...
                                  className="flex items-center gap-4 rounded-lg bg-green-50 p-3"
                                >
                                  ...
                                  <div className="ml-auto">
                                    <span className="text-sm font-medium">
                                      Amount:{' '}
                                      {formatCurrencySync(
                                        (med.price * med.dispensedQuantity) / med.quantity
                                      )}
                                    </span>
                                  </div>
                                </motion.div>
                ...
                <Card className="sticky top-4">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2 pt-4">
                      <Button
                        onClick={() => {
                          logger.debug('Process Payment button clicked', {
                            totals,
                            invoice: invoice?.id,
          ...
          <div className="space-y-4">
            <div className="space-y-2 rounded-lg bg-muted p-4">
              ...
              <div className="flex justify-between text-lg font-bold text-primary">
                ...
                <span>
                  {formatCurrencySync(paymentAmount ? parseFloat(paymentAmount) : totals.total)}
                </span>
              </div>
