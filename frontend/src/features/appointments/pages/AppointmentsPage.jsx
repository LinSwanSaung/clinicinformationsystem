                        ...
                        <div className="space-y-4">
                          ...
                          <div className="rounded-md border border-blue-200 bg-blue-50 p-2 sm:p-3">
                            <div className="flex items-start gap-2 text-blue-800">
                              ...
                              <div className="text-xs sm:text-sm">
                                <p className="mb-1 font-medium">Appointment Scheduling Policy</p>
                                    ...
                                    {generateCalendarDays(calendarMonth).map((date, index) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          className={`relative flex h-6 min-h-[24px] w-full items-center justify-center overflow-hidden rounded-sm border-0 text-[10px] font-medium transition-all duration-200 sm:h-7 sm:min-h-[28px] sm:rounded-md sm:border sm:text-xs md:h-8 md:min-h-[32px] md:text-sm lg:h-9 lg:min-h-[36px] ${!isCurrentMonth ? 'text-muted-foreground/30' : ''} ${isDisabled ? 'text-muted-foreground/40 cursor-not-allowed bg-gray-100' : ''} ${
                                            isAvailable && !isDisabled && isCurrentMonth
                                              ? 'transform border-2 border-green-300 bg-green-100 text-green-800 shadow-sm hover:scale-105 hover:bg-green-200 hover:shadow-md'
                                              : ''
                                          } ${
                                            !isAvailable &&
                                            !isDisabled &&
                                            ...
                                            isSelected
                                              ? 'scale-105 transform bg-blue-200 font-bold text-blue-900 shadow-lg ring-2 ring-blue-400 hover:bg-blue-300'
                                              : ''
                                          } ${isToday && !isSelected ? 'bg-orange-50/50 font-semibold text-orange-700 line-through ring-2 ring-orange-400' : ''} ${
                                            !isAvailable &&
                                            !isDisabled &&
                                            !selectedDoctor &&
                                            isCurrentMonth
                          ...
                          <div>
                            ...
                            {selectedDoctor &&
                              ...
                              availableTimeSlots.length > 0 &&
                              !isLoadingTimeSlots && (
                                <div className="mt-2 rounded-md border border-blue-200 bg-blue-50 p-1.5 sm:p-2">
