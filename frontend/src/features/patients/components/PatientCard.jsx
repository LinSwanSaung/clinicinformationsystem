        ...
        <div className="mb-4 flex items-start justify-between">
          <div className="min-w-0 flex-1">
              ...
              {patient.tokenNumber && (
                <Badge
                  className={`px-2 py-1 text-lg font-bold ${
                    isUrgent
                      ? 'border-red-300 dark:border-red-800 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200'
                      : isHighPriority
                        ? 'border-orange-300 dark:border-orange-800 bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-200'
            ...
            {patient.chief_complaint && (
              <div className="mb-2 rounded-md bg-blue-50 dark:bg-blue-950/30 p-2 text-sm text-foreground">
                <span className="font-medium text-blue-700 dark:text-blue-300">Reason:</span> {patient.chief_complaint}
              </div>
            )}
