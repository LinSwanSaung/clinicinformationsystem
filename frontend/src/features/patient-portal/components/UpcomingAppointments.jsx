...
import { AppointmentDetailModal } from '@/features/appointments';
...
const AppointmentSkeleton = () => (
  <Card className="p-6">
    ...
    <div className="space-y-4">
      {[0, 1].map((idx) => (
        <div key={idx} className="border-border/70 space-y-3 rounded-lg border p-4">
...
const AppointmentCard = ({ appointment, t, onViewDetails, i18n }) => {
  ...
  return (
    <motion.li
      ...
      className="border-border/60 shadow-xs rounded-lg border bg-background p-4 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2"
    >
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>
              {appointment?.doctor?.specialty ??
                ...
                t('patient.appointmentsList.unknownDepartment')}
            </span>
          </div>
        </div>
  ...
  return (
    ...
    >
      <Card className="border-border/80 border shadow-sm">
        ...
        <CardContent>
          {items.length === 0 ? (
            <div className="border-muted-foreground/40 bg-muted/10 space-y-4 rounded-lg border border-dashed p-6 text-center">
              <p className="text-lg font-medium text-foreground">
                {t('patient.appointmentsList.emptyTitle')}
              </p>
              <p className="text-sm text-muted-foreground">
