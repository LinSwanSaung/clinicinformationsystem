...
class AppointmentService {
  ...
  async getAllAppointments(filters = {}) {
    ...
    if (date) {
      return this.appointmentModel.getByDate(date);
    }

    if (patient_id) {
      return this.appointmentModel.getByPatientId(patient_id);
    }

    if (doctor_id) {
      return this.appointmentModel.getByDoctorId(doctor_id);
    }

    return this.appointmentModel.getAllWithDetails();
  }
