...
import { AllergyForm, DiagnosisForm, PatientVitalsDisplay, MedicalInformationPanel, ClinicalNotesDisplay, PatientDocumentManager, allergyService, diagnosisService, prescriptionService, doctorNotesService, documentService } from '@/features/medical';
